        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center">
              <h1 className="text-2xl font-bold text-gray-900">AI Medical Consultation</h1>
              <span className="ml-4 px-3 py-1 text-sm bg-blue-100 text-blue-800 rounded-full">
                {currentStep === 'patient-input' && 'Step 1: Patient Input'}
                {currentStep === 'doctor-review' && 'Step 2: Doctor Review'}
                {currentStep === 'prescription' && 'Step 3: Prescription'}
              </span>
            </div>
            <button
      ...
      <footer className="bg-white border-t mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="text-center text-sm text-gray-500">
            <p>This AI-powered medical consultation system is for informational purposes only.</p>
            <p className="mt-1">Always consult with a qualified healthcare provider for medical advice.</p>
          </div>
        </div>
      </footer>
    </div>
