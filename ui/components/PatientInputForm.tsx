...
export const PatientInputForm: React.FC<PatientInputFormProps> = ({ onComplete, onLoading }) => {
  ...
  const validateForm = () => {
    ...
    if (!formData.patientDescription.trim()) {
      ...
      newErrors.patientDescription = 'Description must be at least 10 characters';
    }
    ...
    <div className="max-w-4xl mx-auto">
      <div className="bg-white rounded-lg shadow-lg p-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Please provide detailed information about the patient's condition.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              placeholder="Describe the patient's symptoms, concerns, and any relevant details..."
            />
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
              rows={3}
              placeholder="Any relevant medical history, previous conditions, or family history..."
            />
          </div>
