  ...
  return (
    <div className="max-w-6xl mx-auto">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          {doctorRecommendations && (
            <div className="space-y-4">
              ...
              {doctorRecommendations.treatmentPlan && (
                <div>
                  <h4 className="font-medium text-gray-700 mb-2">Primary Recommendations</h4>
              ...
              {doctorRecommendations.treatmentPlan?.examinations && doctorRecommendations.treatmentPlan.examinations.length > 0 && (
                <div>
                  <h4 className="font-medium text-gray-700 mb-2">Recommended Examinations</h4>
                    ...
                    {doctorRecommendations.treatmentPlan.examinations.map((exam: any, index: number) => (
                      <div key={index} className="bg-green-50 p-3 rounded-md">
                        ...
                        <div className="text-sm text-green-700">
                          <div>Reason: {exam.reason}</div>
                          <div>Urgency: {exam.urgency}</div>
                        </div>
                      </div>
                    ))}
                  </div>
              ...
              {doctorRecommendations.treatmentPlan?.lifestyleRecommendations && doctorRecommendations.treatmentPlan.lifestyleRecommendations.length > 0 && (
                <div>
                  <h4 className="font-medium text-gray-700 mb-2">Lifestyle Recommendations</h4>
                  <ul className="list-disc list-inside space-y-1 text-gray-600">
              ...
              {doctorRecommendations.safetyConsiderations && doctorRecommendations.safetyConsiderations.length > 0 && (
                <div>
                  <h4 className="font-medium text-gray-700 mb-2">Safety Considerations</h4>
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          <h3 className="text-xl font-bold text-gray-900 mb-4">Generate Prescription</h3>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                rows={4}
                placeholder="Add any additional context for the prescription..."
              />
            </div>
            ...
            <div className="bg-green-50 border border-green-200 rounded-md p-4">
              <h4 className="font-medium text-green-900 mb-2">Prescription Guidelines</h4>
              <ul className="text-sm text-green-800 space-y-1">
                <li>• Review all medications for interactions</li>
                <li>• Ensure proper dosing instructions</li>
                <li>• Include necessary warnings and side effects</li>
                <li>• Specify duration and refill information</li>
