...
export function PatientConsultation({ userId }: PatientConsultationProps) {
  ...
  const handleSendMessage = async () => {
    ...
    setTimeout(() => {
      const botResponse = {
        ...
        text: `Thank you for that information. This is a demo response for user ${userId}. In the full application, I would process your input and ask relevant follow-up questions.`,
        sender: 'bot' as const,
        timestamp: new Date(),
      };
